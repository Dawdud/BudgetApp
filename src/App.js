...
import EditTransactions from "./components/EditTransaction";
...
class App extends Component {
  ...
  updateTransaction = updateTransaction => {
    let transactions = this.state.transactions.map(transaction => {
      return transaction.id === updateTransaction.id
        ? updateTransaction
        : transaction;
    });
      ...
      <div className="budget-app container">
        ...
        <Modal show={this.state.show} handleClose={this.hideModal}>
          {action === "add" ? (
            ...
            <EditTransactions
              transaction={this.state.transactions[this.state.indexItem]}
        ...
        <Transactions
          ...
          getTransactionIndex={this.getTransactionIndex}
        />
      </div>
    );
  }
